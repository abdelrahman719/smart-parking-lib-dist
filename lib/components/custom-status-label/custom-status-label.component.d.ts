...
type StatusKey = 'paid' | 'not_paid' | 'active' | 'inactive' | 'canceled' | 'deleted' | 'open' | 'inprogress' | 'closed' | 'running' | 'upcoming' | 'default' | 'past' | 'new' | 'resolved' | 'acknowledged' | 'falsepositive';
interface StyleDef {
    color: string;
    bg?: string;
    border?: string;
