...
export declare class CustomCheckBoxFormComponent {
    ...
    circular: boolean;
    /** Box width and height. The tick scales with it. */
    size: string;
