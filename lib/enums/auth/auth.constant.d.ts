...
export declare enum PERMISSIONS {
    ...
    VIOLATION_RULE_CREATE = "VIOLATION-RULE:CREATE",
    VIOLATION_RULE_UPDATE = "VIOLATION-RULE:UPDATE",
    VIOLATION_RULE_DELETE = "VIOLATION-RULE:DELETE",
    VIOLATION_RULE_VIEW = "VIOLATION-RULE:VIEW",
