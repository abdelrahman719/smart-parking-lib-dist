...
export declare class CustomPagesHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CustomPagesHeaderComponent, "custom-pages-header", never, { "headerTitle": { "alias": "headerTitle"; "required": false; "isSignal": true; }; "btnTitle": { "alias": "btnTitle"; "required": false; "isSignal": true; }; "hasTabs": { "alias": "hasTabs"; "required": false; "isSignal": true; }; "pageTabs": { "alias": "pageTabs"; "required": false; "isSignal": true; }; }, { "tabSelected": "tabSelected"; "addAction": "addAction"; }, never, never, true, never>;
}
